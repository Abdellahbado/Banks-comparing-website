...
function Comparer(props) {
  ...
  useEffect(() => {
    fetchData(props.banques[0], props.banques[1]);
  }, []);
  ...
  //   { pres_nom: 'Condition1', frais: '12' },
  //   { pres_nom: 'Condition2', frais: '-1' },
  //   { pres_nom: 'Condition3', frais: '1000' },
  // ];

  // const bank2Conditions = [
  //   { pres_nom: 'Condition1', frais: '121' },
  //   { pres_nom: 'Condition2', frais: '0' },
  //   { pres_nom: 'Condition3', frais: '15' }
    ...
    <Card
      ...
      >
        ...
        <Card.Body>
          ...
          <img className='rounded-5' src={location} width="30" height="30"/> {Info1.adress}
          </Card.Text>
          <Card.Text ><img className='rounded-5' src={telephone} width="30" height="30"/> {Info1.tel}</Card.Text>
          <Card.Text><img className='rounded-5' src={mail} width="30" height="30"/> {Info1.fax}</Card.Text>
        </Card.Body>
      </Card>
    </Col>
    <Col className="mb-3 d-flex justify-content-center">
    <Card
      ...
      >
        ...
        <Card.Body>
          ...
          <img className='rounded-5' src={location} width="30" height="30"/>{Info2.adress}
          </Card.Text>
          <Card.Text><img className='rounded-5' src={telephone} width="30" height="30"/>  {Info2.tel}</Card.Text>
          <Card.Text><img className='rounded-5' src={mail} width="30" height="30"/>  {Info2.fax}</Card.Text>
        </Card.Body>
      </Card>
    </Col>
  </Row>
      ...
      {conditions.map((condition, index) => {
        ...
        return (
          <div className="d-flex justify-content-center" key={index}>
            ...
            />
            <div className="mb-3 text-center border-top-4" style={{width:"38%"}}>
